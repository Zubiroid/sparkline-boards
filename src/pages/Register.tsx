      ...
      <PublicLayout>
        <div className="min-h-[calc(100vh-200px)] flex items-center justify-center py-12 px-4">
          <div className="w-full max-w-md text-center">
            ...
            <h1 className="heading-2 mb-2">Account Created!</h1>
            <p className="text-text-secondary mb-6">
              Welcome to ContentOps. Redirecting you to the app...
            </p>
          </div>
        </div>
      </PublicLayout>
          ...
          <div className="card p-8">
            ...
            <div className="space-y-3 mb-6">
              <button
                ...
                disabled={isLoading}
                className="w-full flex items-center justify-center gap-3 h-11 px-4 border border-border rounded-lg hover:bg-surface-hover transition-colors disabled:opacity-50"
              >
