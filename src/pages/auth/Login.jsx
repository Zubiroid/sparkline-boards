...
export default function Login() {
  ...
  const { signIn, signInWithGoogle, signInWithGitHub, isLoading, error, clearError } = useAuth();
      ...
      <div className="min-h-[calc(100vh-200px)] flex items-center justify-center py-12 px-4">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-text-primary mb-2">Sign in to Workbench</h1>
            <p className="text-text-secondary">Access your content management dashboard</p>
          </div>
          ...
          <div className="card p-8">
            ...
            <div className="space-y-3 mb-6">
              <button
                ...
                disabled={isLoading}
                className="w-full flex items-center justify-center gap-3 py-2.5 px-4 border border-border rounded-lg hover:bg-surface-hover transition-colors disabled:opacity-50"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <Link to="/auth/reset" className="text-sm text-primary hover:text-primary-hover">
                  Forgot password?
                </Link>
              </div>
